...
namespace WebStore.WebAPI.Controllers.Identity
{
    ...
    public class UsersApiController : ControllerBase
    {
        ...
        [HttpPost("UserId")] //POST: api/users/UsersId
        ...
        [HttpPost("UserName/{name}")] // api/users/UsersName/TestUser
        ...
        public async Task<bool> CreateAsync([FromBody] User user)
        {
            ...
            //добавление ошибок создания нового пользоателя в журнал
        ...
        [HttpPost("Role/{role}")] //Post->api/users/admin - добавляет роль админ пользователю, который передается в теле
        ...
        public async Task RemoveLoginAsync([FromBody] User user, string LoginProvider,
            string ProviderKey /*,[FromServices] WebStoreDB db*/)
        {
