...
namespace WebStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly ILogger<AccountController> _Logger;//WebStore.Controllers.AccountController
        ...
        public async Task<IActionResult> Login(LoginViewModel Model)
        {
            ...
            {
                //_Logger.LogInformation("Успешный вход в систему {Model.UserName}", Model.UserName);//так делать не надо!
